describe('Usar Descuento', () => {
    it('Usar cupon de Descuento', () => {
      ...
      cy.get('input#shipEmail.form-control.customerDetails').type('prueba12e@ejemplo.com');
      ...
      cy.get('#discountCode').type('CODE2000');
      cy.get('#addDiscountCode').click();
